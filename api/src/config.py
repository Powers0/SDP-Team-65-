...
CT_DIR = os.path.join(ROOT, "Offensive Models", "contact_outcome", "artifacts") + os.sep
EVLA_DIR = os.path.join(ROOT, "Offensive Models", "EV_and_LA", "artifacts") + os.sep
...
# GMM artifact: produced by Pitch Location Prediction/fit_location_gmm.py
LOCATION_GMM_PATH = os.path.join(ROOT, "Pitch Location Prediction", "artifacts", "location_gmm.pkl")
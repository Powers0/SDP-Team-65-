...
from src.config import SEQ_LEN, PT_DIR, LOC_DIR, ST_DIR, CT_DIR, EVLA_DIR, SHARED_DIR, SERVING_TABLE_PATH, LOCATION_GMM_PATH
...
ART = load_all(PT_DIR, LOC_DIR, ST_DIR, CT_DIR, EVLA_DIR, SHARED_DIR, gmm_path=LOCATION_GMM_PATH)

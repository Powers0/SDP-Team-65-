...
df["effective_velocity"] = abs(df["vy0"])

df["score_diff"] = df["bat_score"] - df["fld_score"]

# pressure: bigger in late, close games
df["pressure"] = df["inning"] / (1 + df["score_diff"].abs())


features = [
    'balls', 'strikes', 'outs_when_up', 'inning',
    'on_1b', 'on_2b', 'on_3b',
    'bat_score', 'fld_score', 'effective_velocity', 'pressure'
]
target = 'pitch_type'
